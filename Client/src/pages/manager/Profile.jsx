...
import { useUpdateManagerProfile } from "@/hooks/manager/useUpdateManagerProfile";
...
const Profile = () => {
  ...
  const { mutateAsync, isPending } = useUpdateManagerProfile();
      ...
      <div className="sm:min-w-xl bg-white rounded-xl shadow-md border border-slate-200 p-6">
        ...
        <div className="flex flex-col items-center mb-6">
          <img
            src={
              preview ||
              `http://localhost:4000${user?.profileImage || "/avatar-holder.avif"}`
            }
            alt="Profile"
